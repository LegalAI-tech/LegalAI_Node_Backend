...
class MatterController {
  ...
  async createMatter(req: LawyerAuthRequest, res: Response, next: NextFunction) {
    try {
  ...
  async listMatters(req: LawyerAuthRequest, res: Response, next: NextFunction) {
    try {
      const lawyerId = req.lawyer!.id;
      const { stage, practiceArea, search, page, limit } = req.query as any;
  ...
  async getMatter(req: LawyerAuthRequest, res: Response, next: NextFunction) {
    try {
      const lawyerId = req.lawyer!.id;
  ...
  async updateMatter(req: LawyerAuthRequest, res: Response, next: NextFunction) {
    try {
      const lawyerId = req.lawyer!.id;
      const { matterId } = req.params;
  ...
  async archiveMatter(req: LawyerAuthRequest, res: Response, next: NextFunction) {
    try {
      const lawyerId = req.lawyer!.id;
      const { matterId } = req.params;
